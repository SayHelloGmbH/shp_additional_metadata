 ...
 * Plugin URI:        #
 * Description:       Extends the attachment meta data to include a much wider range of EXIF and IPTC information when an image is uploaded. Currently supports JPG only.
 * Version:           1.0.0
